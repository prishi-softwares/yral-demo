...
import org.example.yarldemo.shared.ui.component.TimeDurationView
import org.example.yarldemo.shared.util.formatYoutubeInterval

@Composable
internal fun BottomControlView(
                        ...
                        Column(
                            ...
                            if (playerConfig.isDurationVisible) {
                                TimeDurationView(
                                    ...
                                    currentTime = if (isYoutube){ formatYoutubeInterval(currentTime)
                                    } else {
                                        currentTime
                                    },
                                    totalTime = if (isYoutube){
                                        formatYoutubeInterval(totalTime)
                                    } else {
                                        totalTime
                                    }
                                )
