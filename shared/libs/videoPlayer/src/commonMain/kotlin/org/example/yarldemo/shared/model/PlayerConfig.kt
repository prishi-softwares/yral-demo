...
import org.example.yarldemo.shared.util.isDesktop
...
data class PlayerConfig  (
    ...
    var pauseResumeIconSize: Dp = if(isDesktop()) { 30.dp }  else { 40.dp},
    ...
    var fastForwardBackwardIconSize: Dp = if(isDesktop()) { 30.dp }  else { 40.dp},
